...
dataset1 = table2array(readtable("R1_E10 - Copy.xlsx")); columnNames1 = readtable("R1_E10 - Copy.xlsx").Properties.VariableNames;      % Turn table to array for compatibility with functions and better visualization
